  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'Form Analytics', href: '/analytics' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Form Builder Community', href: '/community' },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Streamline your data collection with powerful form building tools. Join thousands of
                businesses who trust FormFlow for their workflow automation needs.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">456 Workflow Plaza, Tech District</span>
              </div>
            </div>

            {/* Newsletter Signup */}
            <div className="space-y-3">
              <h4 className="font-semibold text-sm">Form Building Tips</h4>
              ...
              <p className="text-xs text-muted-foreground">
                Get weekly form optimization tips and feature updates. Unsubscribe anytime.
              </p>
            </div>
          </div>
